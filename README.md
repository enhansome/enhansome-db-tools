...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 51,815 | 🐛 3,334 | 🌐 Java | 📅 2026-09-21 - Free universal database manager and SQL client.
* [HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) ⭐ 6,275 | 🐛 323 | 🌐 Pascal | 📅 2026-09-18 - A lightweight client for managing MySQL, MSSQL and PostgreSQL, written in Delphi.
...
* [Another Redis Desktop Manager](https://github.com/qishibo/AnotherRedisDesktopManager) ⭐ 34,775 | 🐛 160 | 🌐 JavaScript | 📅 2026-08-20 - Free Open Source Redis Manager. Available on Mac, Linux, Windows, Homebrew, Snap, winget, and more.
* [Beekeeper Studio](https://github.com/beekeeper-studio/beekeeper-studio) ⭐ 23,634 | 🐛 1,162 | 🌐 TypeScript | 📅 2026-09-21 - Open Source SQL Editor and Database Manager with a privacy commitment in their mission statement.
* [Pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,510 | 🐛 56 | 🌐 Go | 📅 2026-07-26 - Web-based database browser for PostgreSQL, written in Go and works on macOS, Linux and Windows machines.
...
* [Adminer](https://github.com/vrana/adminer) ⭐ 7,895 | 🐛 2 | 🌐 PHP | 📅 2026-09-19 - Database management in a single PHP file.
...
* [Sequel Ace](https://github.com/Sequel-Ace/Sequel-Ace) ⭐ 7,537 | 🐛 193 | 🌐 Objective-C | 📅 2026-09-21 - MySQL/MariaDB database management for macOS.
...
* [Clidey WhoDB](https://github.com/clidey/whodb) ⭐ 5,035 | 🐛 32 | 🌐 Go | 📅 2026-09-21 - A lightweight database explorer with next-gen UX for all SQL, NoSQL, Caches, and Queues.
* [TablePlus](https://github.com/TablePlus/TablePlus) ⭐ 3,833 | 🐛 1,430 | 📅 2026-03-02 - Modern, native, and friendly GUI tool for relational databases: MySQL, PostgreSQL, SQLite & more.
...
* [Antares SQL](https://github.com/antares-sql/antares) ⭐ 2,652 | 🐛 148 | 🌐 Vue | 📅 2025-10-14 - A modern, fast and productivity driven SQL client with a focus in UX. Available for Mac, Linux and Windows.
...
* [usql](https://github.com/xo/usql) ⭐ 10,118 | 🐛 121 | 🌐 Go | 📅 2026-09-21 - A universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and many other databases including NoSQL and non-relational databases!
* [pg\_activity](https://github.com/julmon/pg_activity) ⭐ 3,038 | 🐛 17 | 🌐 Python | 📅 2026-09-21 - Top-like application for PostgreSQL server activity monitoring.
* [iredis](https://github.com/laixintao/iredis) ⭐ 2,744 | 🐛 49 | 🌐 Python | 📅 2026-09-21 - A Cli for Redis with AutoCompletion and Syntax Highlighting.
* [pspg](https://github.com/okbob/pspg) ⭐ 2,732 | 🐛 1 | 🌐 C | 📅 2026-09-21 - PostgreSQL Pager.
...
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,392 | 🐛 46 | 🌐 Python | 📅 2026-09-20 - PostgreSQL CLI with autocompletion and syntax highlighting.
...
* [litecli](https://github.com/dbcli/litecli) ⭐ 3,304 | 🐛 46 | 🌐 Python | 📅 2026-06-18 - CLI for SQLite Databases with auto-completion and syntax highlighting.
...
* [Bytebase](https://github.com/bytebase/bytebase) ⭐ 14,500 | 🐛 166 | 🌐 Go | 📅 2026-09-21 - Web-based, zero-config, dependency-free database schema change and version control tool for teams.
* [gh-ost](https://github.com/github/gh-ost) ⭐ 13,579 | 🐛 339 | 🌐 Go | 📅 2026-09-10 - Online schema migration for MySQL.
* [flyway](https://github.com/flyway/flyway) ⭐ 10,101 | 🐛 258 | 🌐 Java | 📅 2026-09-15 - Database migration tool.
* [Atlas](https://github.com/ariga/atlas) ⭐ 8,735 | 🐛 274 | 🌐 Go | 📅 2026-09-20 - Inspect and Apply changes to your database schema.
* [liquibase](https://github.com/liquibase/liquibase) ⭐ 5,613 | 🐛 257 | 🌐 Java | 📅 2026-09-21 - Database-independent library for tracking, managing and applying database schema changes.
* [sqldef](https://github.com/k0kubun/sqldef) ⭐ 3,167 | 🐛 21 | 🌐 Go | 📅 2026-09-21 - Idempotent schema management for MySQL, PostgreSQL, and more.
* [Sqitch](https://github.com/sqitchers/sqitch) ⭐ 3,163 | 🐛 84 | 🌐 Perl | 📅 2026-09-14 - Sensible database-native change management for framework-free development and dependable deployment.
...
* [node-pg-migrate](https://github.com/salsita/node-pg-migrate) ⭐ 1,485 | 🐛 49 | 🌐 TypeScript | 📅 2026-09-21 - Node.js database migration management built exclusively for PostgreSQL. (But can also be used for other DBs conforming to SQL standard - e.g. CockroachDB.)
...
* [SchemaHero](https://github.com/schemahero/schemahero) ⭐ 1,270 | 🐛 159 | 🌐 Go | 📅 2026-09-19 - A Kubernetes operator for declarative database schema management (gitops for database schemas).
...
* [DrawDB](https://github.com/drawdb-io/drawdb) ⭐ 39,630 | 🐛 243 | 🌐 JavaScript | 📅 2026-09-17 - Free, simple, and intuitive online database design tool and SQL generator.
* [ChartDB](https://github.com/chartdb/chartdb) ⭐ 22,937 | 🐛 171 | 🌐 TypeScript | 📅 2026-09-13 - Free and Open-source database diagrams editor, visualize and design your DB with a single query.
...
* [tbls](https://github.com/k1LoW/tbls) ⭐ 4,349 | 🐛 55 | 🌐 Go | 📅 2026-09-18 - CI-Friendly tool for document a database, written in Go.
...
* [SchemaCrawler](https://github.com/schemacrawler/SchemaCrawler) ⭐ 1,832 | 🐛 1 | 🌐 Java | 📅 2026-09-20 - A free database schema discovery and comprehension tool.
...
* [Database Design](https://github.com/alextanhongpin/database-design) ⭐ 504 | 🐛 0 | 🌐 Go | 📅 2025-08-26 - Useful tips for designing robust database schema.
...
* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 32,119 | 🐛 2,373 | 🌐 TypeScript | 📅 2026-09-21 - Blazing fast, instant realtime GraphQL APIs on PostgreSQL with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 27,675 | 🐛 405 | 🌐 Haskell | 📅 2026-09-20 - REST API for any PostgreSQL database.
* [Prisma](https://github.com/prismagraphql/prisma) ⚠️ Archived - Turns your database into a realtime GraphQL API.
* [PostGraphile](https://github.com/graphile/postgraphile) ⭐ 12,935 | 🐛 170 | 🌐 TypeScript | 📅 2026-09-20 - Instantly spin-up a GraphQL API server by pointing PostGraphile at your existing PostgreSQL database.
* [Datasette](https://github.com/simonw/datasette) ⭐ 11,478 | 🐛 670 | 🌐 Python | 📅 2026-09-17 - A tool for exploring and publishing data.
* [prest](https://github.com/prest/prest) ⭐ 4,620 | 🐛 153 | 🌐 Go | 📅 2026-09-18 - Is a way to serve a RESTful API from any databases written in Go.
...
* [Graphweaver](https://github.com/exogee-technology/graphweaver) ⭐ 556 | 🐛 13 | 🌐 TypeScript | 📅 2026-09-21 - Turn multiple data sources into a single GraphQL API.
...
* [Tooljet](https://github.com/ToolJet/ToolJet) ⭐ 40,949 | 🐛 1,232 | 🌐 JavaScript | 📅 2026-09-21 - Open-source low-code platform to build internal tools.
* [Appsmith](https://github.com/appsmithorg/appsmith) ⭐ 40,915 | 🐛 4,489 | 🌐 TypeScript | 📅 2026-09-21 - Powerful open source low code framework to build internal applications really quickly.
* [Budibase](https://github.com/Budibase/budibase) ⭐ 28,293 | 🐛 268 | 🌐 TypeScript | 📅 2026-09-21 - Low-code platform for creating internal apps in minutes.
...
* [Nhost](https://github.com/nhost/nhost) ⭐ 9,295 | 🐛 178 | 🌐 Go | 📅 2026-09-21 - The Open Source Firebase Alternative with GraphQL.
* [SQLPage](https://github.com/sqlpage/SQLPage) ⭐ 2,566 | 🐛 140 | 🌐 Rust | 📅 2026-09-20 - Fast SQL-only data application builder. Automatically build a UI on top of SQL queries.
...
* [Databasus](https://github.com/databasus/databasus) ⭐ 8,612 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-19 - Tool for scheduled PostgreSQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
* [pgbackrest](https://github.com/pgbackrest/pgbackrest) ⭐ 4,392 | 🐛 25 | 🌐 C | 📅 2026-09-17 - Reliable PostgreSQL Backup & Restore.
* [BaRMan](https://github.com/2ndquadrant-it/barman) ⭐ 3,244 | 🐛 44 | 🌐 Python | 📅 2026-09-18 - Backup and Recovery Manager for PostgreSQL.
* [Portabase](https://github.com/Portabase/portabase) ⭐ 1,756 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-17 - Agent-based platform for PostgreSQL backups and restores with decentralized execution and centralized orchestration.
* [pgcopydb](https://github.com/dimitri/pgcopydb) ⭐ 1,561 | 🐛 39 | 🌐 C | 📅 2026-08-28 - Copy a PostgreSQL database to a target PostgreSQL server (pg\_dump | pg\_restore on steroids).
...
* [clone\_schema](https://github.com/denishpatel/pg-clone-schema) ⭐ 211 | 🐛 0 | 🌐 PLpgSQL | 📅 2026-09-20 - PostgreSQL clone schema utility without need of going outside of database.
...
* [Telegraf PostgreSQL plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/postgresql) ⭐ 17,820 | 🐛 412 | 🌐 Go | 📅 2026-09-21 - Provides metrics for your PostgreSQL database.
...
* [Percona Monitoring and Management](https://github.com/percona/pmm) ⭐ 1,106 | 🐛 237 | 🌐 Go | 📅 2026-09-21 - Open source platform for managing and monitoring MySQL and MongoDB performance.
...
* [pganalyze collector](https://github.com/pganalyze/collector) ⭐ 405 | 🐛 32 | 🌐 Go | 📅 2026-09-18 - Pganalyze statistics collector for gathering PostgreSQL metrics and log data.
...
* [SQLancer](https://github.com/sqlancer/sqlancer) ⭐ 1,755 | 🐛 141 | 🌐 Java | 📅 2026-09-20 - Automatically test DBMS in order to find logic bugs in their implementation.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 21,350 | 🐛 1,115 | 🌐 Go | 📅 2026-09-19 - Database clustering system for horizontal scaling of MySQL through generalized sharding.
* [ShardingSphere](https://github.com/apache/shardingsphere) ⭐ 20,801 | 🐛 209 | 🌐 Java | 📅 2026-09-21 - Distributed SQL transaction & query engine for data sharding, scaling, encryption, and more - on any database.
...
* [patroni](https://github.com/zalando/patroni) ⭐ 8,734 | 🐛 54 | 🌐 Python | 📅 2026-09-17 - A template for PostgreSQL High Availability with ZooKeeper, etcd, or Consul.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,393 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-21 - Open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
* [pg\_auto\_failover](https://github.com/citusdata/pg_auto_failover) ⭐ 1,391 | 🐛 108 | 🌐 C | 📅 2026-09-07 - PostgreSQL extension and service for automated failover and high-availability.
* [pgslice](https://github.com/ankane/pgslice) ⭐ 1,246 | 🐛 4 | 🌐 Ruby | 📅 2026-06-29 - PostgreSQL partitioning as easy as pie.
* [Percona XtraDB Cluster](https://github.com/percona/percona-xtradb-cluster) ⭐ 388 | 🐛 17 | 🌐 C++ | 📅 2026-09-20 - A High Scalability Solution for MySQL Clustering and High Availability.
...
* [MySQLTuner-perl](https://github.com/major/MySQLTuner-perl) ⭐ 9,479 | 🐛 9 | 🌐 Perl | 📅 2026-09-21 - Script written in Perl that allows you to review a MySQL installation quickly and make adjustments to increase performance and stability.
* [postgresqltuner.pl](https://github.com/jfcoz/postgresqltuner) ⭐ 2,701 | 🐛 13 | 🌐 Perl | 📅 2024-01-08 - Simple script to analyse your PostgreSQL database configuration, and give tuning advice.
...
* [Postgres.app](https://github.com/PostgresApp/PostgresApp) ⭐ 7,782 | 🐛 147 | 🌐 Makefile | 📅 2026-09-15 - Full-featured PostgreSQL installation packaged as a standard Mac app.
...
* [dbatools](https://github.com/sqlcollaborative/dbatools) ⭐ 2,840 | 🐛 41 | 🌐 PowerShell | 📅 2026-09-21 - PowerShell module that you may think of like a command-line SQL Server Management Studio.
...
* [Databunker](https://github.com/securitybunker/databunker) ⭐ 1,486 | 🐛 4 | 🌐 Go | 📅 2026-07-28 - Special GDPR compliant secure vault for customer records built on top of regular DB.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,883 | 🐛 330 | 🌐 Python | 📅 2026-09-21 - Dialect-flexible and configurable SQL linter.
...
* [SQL Formatter](https://github.com/zeroturnaround/sql-formatter) ⭐ 2,894 | 🐛 82 | 🌐 TypeScript | 📅 2026-09-16 - JavaScript library for pretty-printing SQL queries.
* [pgFormatter](https://github.com/darold/pgFormatter) ⭐ 1,956 | 🐛 16 | 🌐 PLpgSQL | 📅 2026-09-20 - A PostgreSQL SQL syntax beautifier.
...
* [jOOQ](https://github.com/jOOQ/jOOQ) ⭐ 6,791 | 🐛 2,118 | 🌐 Java | 📅 2026-09-14 - Parses SQL, translates it to other dialects, and allows for expression tree transformations.
* [JSqlParser](https://github.com/JSQLParser/JSqlParser) ⭐ 5,965 | 🐛 11 | 🌐 Java | 📅 2026-09-21 - Parses an SQL statement and translate it into a hierarchy of Java classes.
* [sqlparse](https://github.com/andialbrecht/sqlparse) ⭐ 4,018 | 🐛 299 | 🌐 Python | 📅 2026-08-13 - Non-validating SQL parser for Python.
...
* [osquery](https://github.com/osquery/osquery) ⭐ 23,582 | 🐛 611 | 🌐 C++ | 📅 2026-09-17 - SQL powered operating system instrumentation, monitoring, and analytics.
* [Trino](https://github.com/trinodb/trino) ⭐ 13,265 | 🐛 2,756 | 🌐 Java | 📅 2026-09-21 - Distributed SQL query engine designed to query large data sets distributed over one or more heterogeneous data sources.
* [TextQL](https://github.com/dinedal/textql) ⭐ 9,104 | 🐛 38 | 🌐 Go | 📅 2023-10-22 - Execute SQL against structured text like CSV or TSV.
* [Steampipe](https://github.com/turbot/steampipe) ⭐ 7,961 | 🐛 20 | 🌐 Go | 📅 2026-09-17 - Use SQL to instantly query your cloud services (AWS, Azure, GCP and more).
* [CloudQuery](https://github.com/cloudquery/cloudquery) ⭐ 6,522 | 🐛 166 | 🌐 Go | 📅 2026-09-21 - Extracts, transforms, and loads your cloud assets into normalized PostgreSQL tables.
...
* [sq](https://github.com/neilotoole/sq) ⭐ 2,567 | 🐛 74 | 🌐 Go | 📅 2026-09-20 - Command line tool that provides jq-style access to structured data sources: SQL databases, or document formats like CSV or Excel. It is the lovechild of sql+jq.
...
* [DBA MultiTool](https://github.com/LowlyDBA/dba-multitool) ⭐ 106 | 🐛 2 | 🌐 PLpgSQL | 📅 2026-09-20 - T-SQL scripts for the long haul: optimizing storage, on-the-fly documentation, and general administrative needs for SQL Server.
...
* [dbt](https://github.com/dbt-labs/dbt-core) ⭐ 13,892 | 🐛 1,572 | 🌐 Rust | 📅 2026-09-21 - Transform your data by simply writing select statements, while dbt handles turning these statements into tables and views in a data warehouse.
* [QuickTable](https://quicktable.io) - Empowers everyone to access, clean, analyze, transform, and model data with no code.

### Catalog

* [DataHub](https://github.com/datahub-project/datahub) ⭐ 12,742 | 🐛 1,318 | 🌐 Python | 📅 2026-09-21 - The Metadata Platform for the Modern Data Stack.
...
* [YData Profiling](https://github.com/ydataai/ydata-profiling) ⭐ 13,704 | 🐛 329 | 🌐 Python | 📅 2026-09-11 - A general-purpose open-source data profiler for high-level analysis of a dataset.
...
* [Litestream](https://github.com/benbjohnson/litestream) ⭐ 14,385 | 🐛 149 | 🌐 Go | 📅 2026-09-14 - Streaming replication for SQLite.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,759 | 🐛 6 | 🌐 Makefile | 📅 2026-09-16 - In-database Machine Learning.
