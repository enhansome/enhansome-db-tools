...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 51,830 | 🐛 3,332 | 🌐 Java | 📅 2026-09-22 - Free universal database manager and SQL client.
...
* [Another Redis Desktop Manager](https://github.com/qishibo/AnotherRedisDesktopManager) ⭐ 34,780 | 🐛 161 | 🌐 JavaScript | 📅 2026-08-20 - Free Open Source Redis Manager. Available on Mac, Linux, Windows, Homebrew, Snap, winget, and more.
* [Beekeeper Studio](https://github.com/beekeeper-studio/beekeeper-studio) ⭐ 23,639 | 🐛 1,159 | 🌐 TypeScript | 📅 2026-09-21 - Open Source SQL Editor and Database Manager with a privacy commitment in their mission statement.
* [Pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,511 | 🐛 56 | 🌐 Go | 📅 2026-07-26 - Web-based database browser for PostgreSQL, written in Go and works on macOS, Linux and Windows machines.
...
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,939 | 🐛 928 | 🌐 PHP | 📅 2026-09-20 - A web interface for MySQL and MariaDB.
* [Adminer](https://github.com/vrana/adminer) ⭐ 7,897 | 🐛 0 | 🌐 PHP | 📅 2026-09-21 - Database management in a single PHP file.
...
* [Sequel Ace](https://github.com/Sequel-Ace/Sequel-Ace) ⭐ 7,536 | 🐛 191 | 🌐 Objective-C | 📅 2026-09-21 - MySQL/MariaDB database management for macOS.
...
* [Clidey WhoDB](https://github.com/clidey/whodb) ⭐ 5,033 | 🐛 36 | 🌐 Go | 📅 2026-09-22 - A lightweight database explorer with next-gen UX for all SQL, NoSQL, Caches, and Queues.
* [TablePlus](https://github.com/TablePlus/TablePlus) ⭐ 3,833 | 🐛 1,431 | 📅 2026-03-02 - Modern, native, and friendly GUI tool for relational databases: MySQL, PostgreSQL, SQLite & more.
...
* [Antares SQL](https://github.com/antares-sql/antares) ⭐ 2,653 | 🐛 148 | 🌐 Vue | 📅 2025-10-14 - A modern, fast and productivity driven SQL client with a focus in UX. Available for Mac, Linux and Windows.
...
* [pg\_activity](https://github.com/julmon/pg_activity) ⭐ 3,039 | 🐛 17 | 🌐 Python | 📅 2026-09-21 - Top-like application for PostgreSQL server activity monitoring.
...
* [sqlite-utils](https://github.com/simonw/sqlite-utils) ⭐ 2,171 | 🐛 119 | 🌐 Python | 📅 2026-09-02 - CLI tools for manipulating SQLite database files - inserting data, running queries, creating indexes, configuring full-text search and more.
...
* [pgcenter](https://github.com/lesovsky/pgcenter) ⭐ 1,628 | 🐛 1 | 🌐 Go | 📅 2026-09-10 - Top-like admin tool for PostgreSQL.
...
* [mycli](https://github.com/dbcli/mycli) ⭐ 11,977 | 🐛 1 | 🌐 Python | 📅 2026-09-22 - A Terminal Client for MySQL with AutoCompletion and Syntax Highlighting.
...
* [Bytebase](https://github.com/bytebase/bytebase) ⭐ 14,500 | 🐛 159 | 🌐 Go | 📅 2026-09-22 - Web-based, zero-config, dependency-free database schema change and version control tool for teams.
* [gh-ost](https://github.com/github/gh-ost) ⭐ 13,580 | 🐛 339 | 🌐 Go | 📅 2026-09-10 - Online schema migration for MySQL.
* [flyway](https://github.com/flyway/flyway) ⭐ 10,103 | 🐛 258 | 🌐 Java | 📅 2026-09-15 - Database migration tool.
* [Atlas](https://github.com/ariga/atlas) ⭐ 8,738 | 🐛 273 | 🌐 Go | 📅 2026-09-20 - Inspect and Apply changes to your database schema.
* [liquibase](https://github.com/liquibase/liquibase) ⭐ 5,614 | 🐛 256 | 🌐 Java | 📅 2026-09-22 - Database-independent library for tracking, managing and applying database schema changes.
...
* [SchemaHero](https://github.com/schemahero/schemahero) ⭐ 1,272 | 🐛 159 | 🌐 Go | 📅 2026-09-19 - A Kubernetes operator for declarative database schema management (gitops for database schemas).
...
* [DrawDB](https://github.com/drawdb-io/drawdb) ⭐ 39,662 | 🐛 241 | 🌐 JavaScript | 📅 2026-09-21 - Free, simple, and intuitive online database design tool and SQL generator.
* [ChartDB](https://github.com/chartdb/chartdb) ⭐ 22,943 | 🐛 171 | 🌐 TypeScript | 📅 2026-09-13 - Free and Open-source database diagrams editor, visualize and design your DB with a single query.
* [Liam ERD](https://github.com/liam-hq/liam) ⭐ 5,115 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-21 - Open-source tool that generates beautiful and easy-to-read Entity Relationship Diagrams from your database and ORMs.
* [Azimutt](https://github.com/azimuttapp/azimutt) ⭐ 2,184 | 🐛 83 | 🌐 Elm | 📅 2026-08-25 - An Entity Relationship diagram (ERD) visualization tool, with various filters and inputs to help understand your database schema.
...
* [Schema Spy](https://github.com/schemaspy/schemaspy) ⭐ 3,725 | 🐛 303 | 🌐 HTML | 📅 2026-03-05 - Generating your database to HTML documentation, including Entity Relationship diagrams.
...
* [SchemaCrawler](https://github.com/schemacrawler/SchemaCrawler) ⭐ 1,834 | 🐛 0 | 🌐 Java | 📅 2026-09-22 - A free database schema discovery and comprehension tool.
...
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 27,676 | 🐛 405 | 🌐 Haskell | 📅 2026-09-21 - REST API for any PostgreSQL database.
...
* [Remult](https://github.com/remult/remult) ⭐ 3,211 | 🐛 118 | 🌐 TypeScript | 📅 2026-09-19 - End-to-end type-safe CRUD via REST API for your database, with fine-grained access control.
* [sandman2](https://github.com/jeffknupp/sandman2) ⭐ 2,042 | 🐛 45 | 🌐 Python | 📅 2026-09-21 - Automatically generate a RESTful API service for your legacy database.
...
* [Graphweaver](https://github.com/exogee-technology/graphweaver) ⭐ 556 | 🐛 14 | 🌐 TypeScript | 📅 2026-09-22 - Turn multiple data sources into a single GraphQL API.
...
* [JdbcREST](https://github.com/synthesized-io/jdbcrest/) ⭐ 11 | 🐛 3 | 🌐 Java | 📅 2026-09-21 - REST API for any JDBC-backed database, a PostgREST clone written in Java.
...
* [Tooljet](https://github.com/ToolJet/ToolJet) ⭐ 40,970 | 🐛 1,236 | 🌐 JavaScript | 📅 2026-09-22 - Open-source low-code platform to build internal tools.
* [Appsmith](https://github.com/appsmithorg/appsmith) ⭐ 40,924 | 🐛 4,485 | 🌐 TypeScript | 📅 2026-09-21 - Powerful open source low code framework to build internal applications really quickly.
* [Budibase](https://github.com/Budibase/budibase) ⭐ 28,295 | 🐛 269 | 🌐 TypeScript | 📅 2026-09-22 - Low-code platform for creating internal apps in minutes.
...
* [Nhost](https://github.com/nhost/nhost) ⭐ 9,296 | 🐛 177 | 🌐 Go | 📅 2026-09-22 - The Open Source Firebase Alternative with GraphQL.
* [SQLPage](https://github.com/sqlpage/SQLPage) ⭐ 2,566 | 🐛 141 | 🌐 Rust | 📅 2026-09-20 - Fast SQL-only data application builder. Automatically build a UI on top of SQL queries.
* [Saltcorn](https://github.com/saltcorn/saltcorn) ⭐ 2,072 | 🐛 743 | 🌐 JavaScript | 📅 2026-09-19 - Open source no-code builder for web datatabase applications. Server and drag-and-drop UI builder, data stored in PostgreSQL or SQLite.

## Backup

* [Databasus](https://github.com/databasus/databasus) ⭐ 8,622 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-21 - Tool for scheduled PostgreSQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
* [pgbackrest](https://github.com/pgbackrest/pgbackrest) ⭐ 4,395 | 🐛 25 | 🌐 C | 📅 2026-09-17 - Reliable PostgreSQL Backup & Restore.
* [BaRMan](https://github.com/2ndquadrant-it/barman) ⭐ 3,244 | 🐛 44 | 🌐 Python | 📅 2026-09-18 - Backup and Recovery Manager for PostgreSQL.
* [Portabase](https://github.com/Portabase/portabase) ⭐ 1,759 | 🐛 33 | 🌐 TypeScript | 📅 2026-09-17 - Agent-based platform for PostgreSQL backups and restores with decentralized execution and centralized orchestration.
...
* [Telegraf PostgreSQL plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/postgresql) ⭐ 17,819 | 🐛 426 | 🌐 Go | 📅 2026-09-21 - Provides metrics for your PostgreSQL database.
...
* [Percona Monitoring and Management](https://github.com/percona/pmm) ⭐ 1,106 | 🐛 237 | 🌐 Go | 📅 2026-09-22 - Open source platform for managing and monitoring MySQL and MongoDB performance.
...
* [pganalyze collector](https://github.com/pganalyze/collector) ⭐ 405 | 🐛 33 | 🌐 Go | 📅 2026-09-18 - Pganalyze statistics collector for gathering PostgreSQL metrics and log data.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 21,351 | 🐛 1,121 | 🌐 Go | 📅 2026-09-21 - Database clustering system for horizontal scaling of MySQL through generalized sharding.
* [ShardingSphere](https://github.com/apache/shardingsphere) ⭐ 20,801 | 🐛 206 | 🌐 Java | 📅 2026-09-22 - Distributed SQL transaction & query engine for data sharding, scaling, encryption, and more - on any database.
* [Citus](https://github.com/citusdata/citus) ⭐ 12,782 | 🐛 1,078 | 🌐 C | 📅 2026-09-22 - PostgreSQL extension that distributes your data and your queries across multiple nodes.
* [patroni](https://github.com/zalando/patroni) ⭐ 8,736 | 🐛 56 | 🌐 Python | 📅 2026-09-17 - A template for PostgreSQL High Availability with ZooKeeper, etcd, or Consul.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,396 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-21 - Open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [Percona XtraDB Cluster](https://github.com/percona/percona-xtradb-cluster) ⭐ 388 | 🐛 15 | 🌐 C++ | 📅 2026-09-21 - A High Scalability Solution for MySQL Clustering and High Availability.
...
* [PostgreSQL operator](https://github.com/zalando/postgres-operator) ⭐ 5,245 | 🐛 548 | 🌐 Go | 📅 2026-09-16 - The PostgreSQL Operator enables highly-available PostgreSQL clusters on Kubernetes (Kubernetes) powered by Patroni.
...
* [postgresqltuner.pl](https://github.com/jfcoz/postgresqltuner) ⭐ 2,703 | 🐛 13 | 🌐 Perl | 📅 2024-01-08 - Simple script to analyse your PostgreSQL database configuration, and give tuning advice.
...
* [dbatools](https://github.com/sqlcollaborative/dbatools) ⭐ 2,841 | 🐛 41 | 🌐 PowerShell | 📅 2026-09-21 - PowerShell module that you may think of like a command-line SQL Server Management Studio.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,885 | 🐛 344 | 🌐 Python | 📅 2026-09-22 - Dialect-flexible and configurable SQL linter.
* [SQLCheck](https://github.com/jarulraj/sqlcheck) ⭐ 2,524 | 🐛 14 | 🌐 C++ | 📅 2024-02-21 - Automatically detects common SQL anti-patterns.
* [SQLLineage](https://github.com/reata/sqllineage) ⭐ 1,677 | 🐛 47 | 🌐 Python | 📅 2026-09-21 - SQL Lineage Analysis Tool powered by Python.
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,628 | 🐛 6 | 🌐 Python | 📅 2026-09-21 - Pure Python SQL parser, transpiler, and builder.
* [jOOQ](https://github.com/jOOQ/jOOQ) ⭐ 6,793 | 🐛 2,117 | 🌐 Java | 📅 2026-09-21 - Parses SQL, translates it to other dialects, and allows for expression tree transformations.
* [JSqlParser](https://github.com/JSQLParser/JSqlParser) ⭐ 5,965 | 🐛 8 | 🌐 Java | 📅 2026-09-21 - Parses an SQL statement and translate it into a hierarchy of Java classes.
* [sqlparse](https://github.com/andialbrecht/sqlparse) ⭐ 4,018 | 🐛 300 | 🌐 Python | 📅 2026-08-13 - Non-validating SQL parser for Python.
...
* [osquery](https://github.com/osquery/osquery) ⭐ 23,585 | 🐛 612 | 🌐 C++ | 📅 2026-09-17 - SQL powered operating system instrumentation, monitoring, and analytics.
* [Trino](https://github.com/trinodb/trino) ⭐ 13,266 | 🐛 2,750 | 🌐 Java | 📅 2026-09-22 - Distributed SQL query engine designed to query large data sets distributed over one or more heterogeneous data sources.
...
* [sqls](https://github.com/lighttiger2505/sqls) ⭐ 1,337 | 🐛 46 | 🌐 Go | 📅 2026-08-20 - SQL Language Server written in Go.
...
* [dbt](https://github.com/dbt-labs/dbt-core) ⭐ 13,901 | 🐛 1,566 | 🌐 Rust | 📅 2026-09-22 - Transform your data by simply writing select statements, while dbt handles turning these statements into tables and views in a data warehouse.
* [QuickTable](https://quicktable.io) - Empowers everyone to access, clean, analyze, transform, and model data with no code.

### Catalog

* [DataHub](https://github.com/datahub-project/datahub) ⭐ 12,747 | 🐛 1,306 | 🌐 Python | 📅 2026-09-22 - The Metadata Platform for the Modern Data Stack.
...
* [Faker](https://github.com/faker-js/faker) ⭐ 15,493 | 🐛 98 | 🌐 TypeScript | 📅 2026-09-22 - Generate massive amounts of fake data in the browser and Node.js.
...
* [YData Profiling](https://github.com/ydataai/ydata-profiling) ⭐ 13,705 | 🐛 329 | 🌐 Python | 📅 2026-09-11 - A general-purpose open-source data profiler for high-level analysis of a dataset.
...
* [Desbordante](https://github.com/desbordante/desbordante-core) ⭐ 504 | 🐛 90 | 🌐 C++ | 📅 2026-09-21 - An open-source data profiler specifically focused on discovery and validation of complex patterns in data.

### Replication

* [Litestream](https://github.com/benbjohnson/litestream) ⭐ 14,387 | 🐛 152 | 🌐 Go | 📅 2026-09-21 - Streaming replication for SQLite.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,763 | 🐛 6 | 🌐 Makefile | 📅 2026-09-16 - In-database Machine Learning.
