...
* [DBeaver](https://github.com/dbeaver/dbeaver) ⭐ 51,872 | 🐛 3,344 | 🌐 Java | 📅 2026-09-25 - Free universal database manager and SQL client.
* [HeidiSQL](https://github.com/HeidiSQL/HeidiSQL) ⭐ 6,278 | 🐛 326 | 🌐 Pascal | 📅 2026-09-22 - A lightweight client for managing MySQL, MSSQL and PostgreSQL, written in Delphi.
...
* [Beekeeper Studio](https://github.com/beekeeper-studio/beekeeper-studio) ⭐ 23,671 | 🐛 1,163 | 🌐 TypeScript | 📅 2026-09-24 - Open Source SQL Editor and Database Manager with a privacy commitment in their mission statement.
* [Pgweb](https://github.com/sosedoff/pgweb) ⭐ 9,514 | 🐛 56 | 🌐 Go | 📅 2026-07-26 - Web-based database browser for PostgreSQL, written in Go and works on macOS, Linux and Windows machines.
...
* [phpMyAdmin](https://github.com/phpmyadmin/phpmyadmin) ⭐ 7,938 | 🐛 930 | 🌐 PHP | 📅 2026-09-23 - A web interface for MySQL and MariaDB.
* [Adminer](https://github.com/vrana/adminer) ⭐ 7,904 | 🐛 0 | 🌐 PHP | 📅 2026-09-21 - Database management in a single PHP file.
...
* [Sequel Ace](https://github.com/Sequel-Ace/Sequel-Ace) ⭐ 7,539 | 🐛 193 | 🌐 Objective-C | 📅 2026-09-21 - MySQL/MariaDB database management for macOS.
...
* [Clidey WhoDB](https://github.com/clidey/whodb) ⭐ 5,031 | 🐛 25 | 🌐 Go | 📅 2026-09-25 - A lightweight database explorer with next-gen UX for all SQL, NoSQL, Caches, and Queues.
* [TablePlus](https://github.com/TablePlus/TablePlus) ⭐ 3,836 | 🐛 1,433 | 📅 2026-03-02 - Modern, native, and friendly GUI tool for relational databases: MySQL, PostgreSQL, SQLite & more.
* [OmniDB](https://github.com/OmniDB/OmniDB) ⭐ 3,284 | 🐛 330 | 🌐 JavaScript | 📅 2023-02-01 - Web tool for database management.
* [Jailer](https://github.com/Wisser/Jailer) ⭐ 3,204 | 🐛 0 | 🌐 Java | 📅 2026-09-24 - Database Subsetting and Relational Data Browsing Tool/Client.
...
* [usql](https://github.com/xo/usql) ⭐ 10,126 | 🐛 74 | 🌐 Go | 📅 2026-09-23 - A universal command-line interface for PostgreSQL, MySQL, Oracle Database, SQLite3, Microsoft SQL Server, and many other databases including NoSQL and non-relational databases!
...
* [iredis](https://github.com/laixintao/iredis) ⭐ 2,755 | 🐛 49 | 🌐 Python | 📅 2026-09-21 - A Cli for Redis with AutoCompletion and Syntax Highlighting.
* [pspg](https://github.com/okbob/pspg) ⭐ 2,735 | 🐛 1 | 🌐 C | 📅 2026-09-21 - PostgreSQL Pager.
* [sqlite-utils](https://github.com/simonw/sqlite-utils) ⭐ 2,172 | 🐛 127 | 🌐 Python | 📅 2026-09-22 - CLI tools for manipulating SQLite database files - inserting data, running queries, creating indexes, configuring full-text search and more.
...
* [pgcli](https://github.com/dbcli/pgcli) ⭐ 13,402 | 🐛 49 | 🌐 Python | 📅 2026-09-20 - PostgreSQL CLI with autocompletion and syntax highlighting.
...
* [Bytebase](https://github.com/bytebase/bytebase) ⭐ 14,508 | 🐛 167 | 🌐 Go | 📅 2026-09-24 - Web-based, zero-config, dependency-free database schema change and version control tool for teams.
...
* [Atlas](https://github.com/ariga/atlas) ⭐ 8,748 | 🐛 273 | 🌐 Go | 📅 2026-09-20 - Inspect and Apply changes to your database schema.
* [liquibase](https://github.com/liquibase/liquibase) ⭐ 5,614 | 🐛 255 | 🌐 Java | 📅 2026-09-25 - Database-independent library for tracking, managing and applying database schema changes.
* [sqldef](https://github.com/k0kubun/sqldef) ⭐ 3,169 | 🐛 10 | 🌐 Go | 📅 2026-09-25 - Idempotent schema management for MySQL, PostgreSQL, and more.
...
* [node-pg-migrate](https://github.com/salsita/node-pg-migrate) ⭐ 1,486 | 🐛 51 | 🌐 TypeScript | 📅 2026-09-25 - Node.js database migration management built exclusively for PostgreSQL. (But can also be used for other DBs conforming to SQL standard - e.g. CockroachDB.)
...
* [DrawDB](https://github.com/drawdb-io/drawdb) ⭐ 39,699 | 🐛 241 | 🌐 JavaScript | 📅 2026-09-24 - Free, simple, and intuitive online database design tool and SQL generator.
* [ChartDB](https://github.com/chartdb/chartdb) ⭐ 22,951 | 🐛 172 | 🌐 TypeScript | 📅 2026-09-13 - Free and Open-source database diagrams editor, visualize and design your DB with a single query.
...
* [tbls](https://github.com/k1LoW/tbls) ⭐ 4,352 | 🐛 55 | 🌐 Go | 📅 2026-09-18 - CI-Friendly tool for document a database, written in Go.
...
* [Oracle Database Sample Schemas](https://github.com/oracle/db-sample-schemas) ⭐ 951 | 🐛 3 | 🌐 PLSQL | 📅 2025-06-25 - Sample schemas for Oracle Database.

## API

Building API for your Data

* [Hasura GraphQL Engine](https://github.com/hasura/graphql-engine) ⭐ 32,120 | 🐛 2,374 | 🌐 TypeScript | 📅 2026-09-21 - Blazing fast, instant realtime GraphQL APIs on PostgreSQL with fine grained access control, also trigger webhooks on database events.
* [PostgREST](https://github.com/PostgREST/postgrest) ⭐ 27,677 | 🐛 404 | 🌐 Haskell | 📅 2026-09-24 - REST API for any PostgreSQL database.
...
* [Datasette](https://github.com/simonw/datasette) ⭐ 11,481 | 🐛 664 | 🌐 Python | 📅 2026-09-25 - A tool for exploring and publishing data.
* [prest](https://github.com/prest/prest) ⭐ 4,618 | 🐛 155 | 🌐 Go | 📅 2026-09-18 - Is a way to serve a RESTful API from any databases written in Go.
* [Remult](https://github.com/remult/remult) ⭐ 3,211 | 🐛 119 | 🌐 TypeScript | 📅 2026-09-19 - End-to-end type-safe CRUD via REST API for your database, with fine-grained access control.
...
* [DreamFactory](https://github.com/dreamfactorysoftware/dreamfactory) ⭐ 1,789 | 🐛 1 | 🌐 Shell | 📅 2026-09-24 - A open source REST API backend for mobile, web, and IoT applications.
...
* [Graphweaver](https://github.com/exogee-technology/graphweaver) ⭐ 556 | 🐛 16 | 🌐 TypeScript | 📅 2026-09-25 - Turn multiple data sources into a single GraphQL API.
...
* [Tooljet](https://github.com/ToolJet/ToolJet) ⭐ 40,993 | 🐛 1,251 | 🌐 JavaScript | 📅 2026-09-25 - Open-source low-code platform to build internal tools.
* [Appsmith](https://github.com/appsmithorg/appsmith) ⭐ 40,941 | 🐛 4,489 | 🌐 TypeScript | 📅 2026-09-25 - Powerful open source low code framework to build internal applications really quickly.
* [Budibase](https://github.com/Budibase/budibase) ⭐ 28,305 | 🐛 267 | 🌐 TypeScript | 📅 2026-09-25 - Low-code platform for creating internal apps in minutes.
* [ILLA Cloud](https://github.com/illacloud/illa-builder) ⭐ 12,324 | 🐛 43 | 🌐 TypeScript | 📅 2026-05-27 - Low-code internal tool building platform.
* [Nhost](https://github.com/nhost/nhost) ⭐ 9,307 | 🐛 184 | 🌐 Go | 📅 2026-09-25 - The Open Source Firebase Alternative with GraphQL.
* [SQLPage](https://github.com/sqlpage/SQLPage) ⭐ 2,567 | 🐛 143 | 🌐 Rust | 📅 2026-09-25 - Fast SQL-only data application builder. Automatically build a UI on top of SQL queries.
* [Saltcorn](https://github.com/saltcorn/saltcorn) ⭐ 2,074 | 🐛 738 | 🌐 JavaScript | 📅 2026-09-25 - Open source no-code builder for web datatabase applications. Server and drag-and-drop UI builder, data stored in PostgreSQL or SQLite.

## Backup

* [Databasus](https://github.com/databasus/databasus) ⭐ 8,652 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-22 - Tool for scheduled PostgreSQL backups via web UI with external storages (local, S3, FTP, Google Drive, etc.), notifications (webhook, Discord, Slack, etc.) and team management.
* [pgbackrest](https://github.com/pgbackrest/pgbackrest) ⭐ 4,406 | 🐛 26 | 🌐 C | 📅 2026-09-24 - Reliable PostgreSQL Backup & Restore.
* [BaRMan](https://github.com/2ndquadrant-it/barman) ⭐ 3,244 | 🐛 42 | 🌐 Python | 📅 2026-09-18 - Backup and Recovery Manager for PostgreSQL.
* [Portabase](https://github.com/Portabase/portabase) ⭐ 1,768 | 🐛 37 | 🌐 TypeScript | 📅 2026-09-24 - Agent-based platform for PostgreSQL backups and restores with decentralized execution and centralized orchestration.
...
* [Telegraf PostgreSQL plugin](https://github.com/influxdata/telegraf/tree/master/plugins/inputs/postgresql) ⭐ 17,831 | 🐛 420 | 🌐 Go | 📅 2026-09-23 - Provides metrics for your PostgreSQL database.
* [PgHero](https://github.com/ankane/pghero) ⭐ 8,933 | 🐛 5 | 🌐 Ruby | 📅 2026-09-06 - A performance dashboard for PostgreSQL - health checks, suggested indexes, and more.
...
* [Percona Monitoring and Management](https://github.com/percona/pmm) ⭐ 1,108 | 🐛 237 | 🌐 Go | 📅 2026-09-25 - Open source platform for managing and monitoring MySQL and MongoDB performance.
...
* [Vitess](https://github.com/vitessio/vitess) ⭐ 21,355 | 🐛 1,130 | 🌐 Go | 📅 2026-09-25 - Database clustering system for horizontal scaling of MySQL through generalized sharding.
* [ShardingSphere](https://github.com/apache/shardingsphere) ⭐ 20,804 | 🐛 206 | 🌐 Java | 📅 2026-09-25 - Distributed SQL transaction & query engine for data sharding, scaling, encryption, and more - on any database.
* [Citus](https://github.com/citusdata/citus) ⭐ 12,784 | 🐛 1,072 | 🌐 C | 📅 2026-09-25 - PostgreSQL extension that distributes your data and your queries across multiple nodes.
* [patroni](https://github.com/zalando/patroni) ⭐ 8,744 | 🐛 59 | 🌐 Python | 📅 2026-09-24 - A template for PostgreSQL High Availability with ZooKeeper, etcd, or Consul.
...
* [autobase](https://github.com/vitabaks/autobase) ⭐ 4,402 | 🐛 27 | 🌐 TypeScript | 📅 2026-09-23 - Open-source DBaaS that automates the deployment and management of highly available PostgreSQL clusters.
...
* [PostgreSQL operator](https://github.com/zalando/postgres-operator) ⭐ 5,249 | 🐛 543 | 🌐 Go | 📅 2026-09-25 - The PostgreSQL Operator enables highly-available PostgreSQL clusters on Kubernetes (Kubernetes) powered by Patroni.
...
* [dbatools](https://github.com/sqlcollaborative/dbatools) ⭐ 2,843 | 🐛 33 | 🌐 PowerShell | 📅 2026-09-25 - PowerShell module that you may think of like a command-line SQL Server Management Studio.
...
* [SQLFluff](https://github.com/sqlfluff/sqlfluff) ⭐ 9,893 | 🐛 341 | 🌐 Python | 📅 2026-09-23 - Dialect-flexible and configurable SQL linter.
...
* [SQL Formatter](https://github.com/zeroturnaround/sql-formatter) ⭐ 2,896 | 🐛 81 | 🌐 TypeScript | 📅 2026-09-23 - JavaScript library for pretty-printing SQL queries.
...
* [SQLGlot](https://github.com/tobymao/sqlglot) ⭐ 9,637 | 🐛 9 | 🌐 Python | 📅 2026-09-25 - Pure Python SQL parser, transpiler, and builder.
* [jOOQ](https://github.com/jOOQ/jOOQ) ⭐ 6,793 | 🐛 2,117 | 🌐 Java | 📅 2026-09-25 - Parses SQL, translates it to other dialects, and allows for expression tree transformations.
* [JSqlParser](https://github.com/JSQLParser/JSqlParser) ⭐ 5,964 | 🐛 6 | 🌐 Java | 📅 2026-09-25 - Parses an SQL statement and translate it into a hierarchy of Java classes.
* [sqlparse](https://github.com/andialbrecht/sqlparse) ⭐ 4,018 | 🐛 301 | 🌐 Python | 📅 2026-08-13 - Non-validating SQL parser for Python.
* [libpg\_query](https://github.com/pganalyze/libpg_query) ⭐ 1,486 | 🐛 69 | 🌐 C | 📅 2026-09-24 - C library for accessing the PostgreSQL parser outside of the server environment.
...
* [osquery](https://github.com/osquery/osquery) ⭐ 23,587 | 🐛 605 | 🌐 C++ | 📅 2026-09-24 - SQL powered operating system instrumentation, monitoring, and analytics.
* [Trino](https://github.com/trinodb/trino) ⭐ 13,279 | 🐛 2,762 | 🌐 Java | 📅 2026-09-25 - Distributed SQL query engine designed to query large data sets distributed over one or more heterogeneous data sources.
* [TextQL](https://github.com/dinedal/textql) ⭐ 9,103 | 🐛 38 | 🌐 Go | 📅 2023-10-22 - Execute SQL against structured text like CSV or TSV.
* [Steampipe](https://github.com/turbot/steampipe) ⭐ 7,964 | 🐛 32 | 🌐 Go | 📅 2026-09-24 - Use SQL to instantly query your cloud services (AWS, Azure, GCP and more).
* [CloudQuery](https://github.com/cloudquery/cloudquery) ⭐ 6,524 | 🐛 167 | 🌐 Go | 📅 2026-09-23 - Extracts, transforms, and loads your cloud assets into normalized PostgreSQL tables.
...
* [dbt](https://github.com/dbt-labs/dbt-core) ⭐ 13,922 | 🐛 1,603 | 🌐 Rust | 📅 2026-09-25 - Transform your data by simply writing select statements, while dbt handles turning these statements into tables and views in a data warehouse.
* [QuickTable](https://quicktable.io) - Empowers everyone to access, clean, analyze, transform, and model data with no code.

### Catalog

* [DataHub](https://github.com/datahub-project/datahub) ⭐ 12,759 | 🐛 1,250 | 🌐 Python | 📅 2026-09-25 - The Metadata Platform for the Modern Data Stack.
...
* [Faker](https://github.com/faker-js/faker) ⭐ 15,496 | 🐛 96 | 🌐 TypeScript | 📅 2026-09-25 - Generate massive amounts of fake data in the browser and Node.js.
...
* [Desbordante](https://github.com/desbordante/desbordante-core) ⭐ 508 | 🐛 88 | 🌐 C++ | 📅 2026-09-24 - An open-source data profiler specifically focused on discovery and validation of complex patterns in data.

### Replication

* [Litestream](https://github.com/benbjohnson/litestream) ⭐ 14,395 | 🐛 155 | 🌐 Go | 📅 2026-09-21 - Streaming replication for SQLite.
...
* [MindsDB](https://github.com/mindsdb/mindsdb) ⭐ 39,770 | 🐛 6 | 🌐 Makefile | 📅 2026-09-16 - In-database Machine Learning.
